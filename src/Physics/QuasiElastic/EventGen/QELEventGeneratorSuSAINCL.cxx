...
#include "Physics/QuasiElastic/EventGen/QELEventGeneratorSuSAINCL.h"
...
QELEventGeneratorSuSAINCL::QELEventGeneratorSuSAINCL() :
KineGeneratorWithCache("genie::QELEventGeneratorSuSAINCL")
{

}
//___________________________________________________________________________
QELEventGeneratorSuSAINCL::QELEventGeneratorSuSAINCL(string config) :
KineGeneratorWithCache("genie::QELEventGeneratorSuSAINCL", config)
{
...
//___________________________________________________________________________
void QELEventGeneratorSuSAINCL::ProcessEventRecord(GHepRecord * event) const
{
  ...
  fNucleusGen->setInitialStateVertex(event);
...
//___________________________________________________________________________
void QELEventGeneratorSuSAINCL::SelectLeptonKinematics (GHepRecord * event) const
{
...
//___________________________________________________________________________
void QELEventGeneratorSuSAINCL::AddTargetNucleusRemnant(GHepRecord * event) const
{
...
//___________________________________________________________________________
void QELEventGeneratorSuSAINCL::GenerateNucleon(GHepRecord * event) const
{
    ...
    while(!accept){
        ...
        p3i = fNucleusGen->GetNuclearModel()->Momentum3();
        ...
        if(!have_nucleus){
        ...
        else if(fForceEbFromModel) removalenergy = fNucleusGen->GetNuclearModel()->RemovalEnergy();
          ...
          removalenergy += (fNucleusGen->GetNuclearModel()->RemovalEnergy()) - fEbC;
...
//___________________________________________________________________________
void QELEventGeneratorSuSAINCL::Configure(const Registry & config)
{
    Algorithm::Configure(config);
    this->LoadConfig();
}
//___________________________________________________________________________
void QELEventGeneratorSuSAINCL::Configure(string config)
{
    Algorithm::Configure(config);
    this->LoadConfig();
}
...
//____________________________________________________________________________
double QELEventGeneratorSuSAINCL::ComputeMaxXSec(
