...
\class    genie::QELEventGeneratorSuSAINCL
...
class QELEventGeneratorSuSAINCL : public KineGeneratorWithCache {

public :
  QELEventGeneratorSuSAINCL();
  QELEventGeneratorSuSAINCL(string config);
 ~QELEventGeneratorSuSAINCL();
