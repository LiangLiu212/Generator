...
\class    genie::EmpiricalMECPXSecINCL
...
#ifndef __EMPIRICAL_MEC_PXSEC_INCL_H__
#define __EMPIRICAL_MEC_PXSEC_INCL_H__
...
class EmpiricalMECPXSecINCL : public XSecAlgorithmI {

public:
  EmpiricalMECPXSecINCL();
  EmpiricalMECPXSecINCL(string config);
  virtual ~EmpiricalMECPXSecINCL();
...
#endif  // __EMPIRICAL_MEC_PXSEC_INCL_H__
