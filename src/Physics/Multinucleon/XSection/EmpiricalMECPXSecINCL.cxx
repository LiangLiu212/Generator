...
#include "Physics/Multinucleon/XSection/EmpiricalMECPXSecINCL.h"
...
//____________________________________________________________________________
EmpiricalMECPXSecINCL::EmpiricalMECPXSecINCL() :
XSecAlgorithmI("genie::EmpiricalMECPXSecINCL")
{

}
//____________________________________________________________________________
EmpiricalMECPXSecINCL::EmpiricalMECPXSecINCL(string config) :
XSecAlgorithmI("genie::EmpiricalMECPXSecINCL", config)
{
...
//____________________________________________________________________________
double EmpiricalMECPXSecINCL::XSec(
...
//____________________________________________________________________________
double EmpiricalMECPXSecINCL::Integral(const Interaction * interaction) const
{
...
//____________________________________________________________________________
bool EmpiricalMECPXSecINCL::ValidProcess(const Interaction * interaction) const
{
...
//____________________________________________________________________________
void EmpiricalMECPXSecINCL::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void EmpiricalMECPXSecINCL::Configure(string config)
{
  Algorithm::Configure(config);
  ...
  Registry r( "EmpiricalMECPXSecINCL_specific", false ) ;
  r.Set( local_key_head + "QEL-NC-INCL", algos -> GetAlg( global_key_head + "QEL-NC-INCL") ) ;
  r.Set( local_key_head + "QEL-CC-INCL", algos -> GetAlg( global_key_head + "QEL-CC-INCL") ) ;
  r.Set( local_key_head + "QEL-EM-INCL", algos -> GetAlg( global_key_head + "QEL-EM-INCL") ) ;
...
//____________________________________________________________________________
void EmpiricalMECPXSecINCL::LoadConfig(void)
{
  fXSecAlgCCQE = 0;
  fXSecAlgNCQE = 0;
  fXSecAlgEMQE = 0;
  ...
  fXSecAlgNCQE =
     dynamic_cast<const XSecAlgorithmI *> ( this -> SubAlg( key_head + "QEL-NC-INCL" ) ) ;
  assert(fXSecAlgNCQE);

  fXSecAlgCCQE =
     dynamic_cast<const XSecAlgorithmI *> ( this -> SubAlg( key_head + "QEL-CC-INCL" ) ) ;
  assert(fXSecAlgCCQE);

  fXSecAlgEMQE =
     dynamic_cast<const XSecAlgorithmI *> ( this -> SubAlg( key_head + "QEL-EM-INCL" ) ) ;
  assert(fXSecAlgEMQE);
